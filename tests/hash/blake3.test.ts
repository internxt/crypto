...
import { getBytesFromDataHex, hashDataHex, getBytesFromStrinHex } from '../../src/hash';
...
describe('Test hash module with blake3 test vectors', () => {
  ...
  it('should compute correct hash value', () => {
    ...
    const result = hashDataHex([message]);
  ...
  it('should pass test with input length 0 from blake3 team', () => {
    const message = '';
    const result = getBytesFromDataHex(expectedLen, [new Uint8Array()]);
    const result_string = getBytesFromStrinHex(expectedLen, message);
  ...
  it('should pass test with input length 1 from blake3 team', () => {
    const message = new Uint8Array([0]);
    const result = getBytesFromDataHex(expectedLen, [message]);
  ...
  it('should pass test with input length 2 from blake3 team', () => {
  ...
  it('should pass test with input length 7 from blake3 team', async () => {
    ...
    const result = await getBytesFromDataHex(expectedLen, [message]);
